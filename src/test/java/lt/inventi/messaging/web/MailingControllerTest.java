...
//         given(mailbox.getAllUserDrafts(TEST_USERNAME)).willReturn(new HashMap<Long, Draft>());
...
//         HashMap<Long, Draft> mockDrafts = new HashMap<Long, Draft>();
//         mockDrafts.put(1L, new Draft());
//         String stringMockedDrafts = objectMapper.writeValueAsString(mockDrafts);
//         given(mailbox.getAllUserDrafts(TEST_USERNAME)).willReturn(mockDrafts);
//         this.mvc.perform(get("/users/{username}/drafts", TEST_USERNAME)
//                             .accept(MediaType.APPLICATION_JSON_VALUE))
//                 .andExpect(status().isOk())
...
//         given(this.mailbox.getUserInbox(TEST_USERNAME)).willReturn(new HashMap<Long, Draft>());
...
//         HashMap<Long, Draft> mockInbox = new HashMap<Long, Draft>();
//         mockInbox.put(1L, new Draft());
